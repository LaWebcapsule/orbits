...
import { BlankResource } from './test-action.js';
...
describe('Resource', () => {
    ...
    beforeAll(() => {
        ...
        return ActionRuntime.activeRuntime.ActionModel.deleteMany({})
            ...
            .then(() => {
                return Promise.all([testResource.save()]);
            })
            .then(() => {
            ...
            .then(() => {
                return Action.trackActionAsPromise(testResourceUpdate, [
                    ActionState.SUCCESS,
                    ActionState.ERROR,
                ]);
            })
            ...
            .then(() => {
                return Action.trackActionAsPromise(testResourceChangeVersion, [
                    ActionState.SUCCESS,
                    ActionState.ERROR,
                ]);
            })
    ...
    it('should be in success', () => {
        ...
        expect(testResourceChangeVersion.dbDoc.state).toEqual(
            ActionState.SUCCESS
        );
