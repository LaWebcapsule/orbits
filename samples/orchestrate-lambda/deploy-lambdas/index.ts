...
export class ApiLambdaCrudDynamoDBStack extends Stack {
    constructor(app: App, id: string) {
        ...
        const checkStockPrice = new NodejsFunction(
            this,
        ...
        const generateBuySellRecommend = new NodejsFunction(
            this,
        ...
        const generateBuySellRecommendIntegration = new LambdaIntegration(
            generateBuySellRecommend
        );
        const checkStockPriceIntegration = new LambdaIntegration(
            checkStockPrice
        );
...
export function addCorsOptions(apiAgent: IAgent) {
    apiAgent.addMethod(
        'OPTIONS',
        new MockIntegration({
